...
\author[Team 10]{
	...
	{\small  E. Pacheco \inst{2}},\,
            T. Pender   \inst{3},\, I. Vin\'icius  \inst{4} ,\, S. Yeal   \inst{1} \\  
...
\begin{frame}{TheoryMesh and food sustainability challenges}
 \begin{block}{A bit background}
	Co-founders:
	\begin{itemize}
		\item Chris Bunio (mentor), Paul Westdal, Stephanie Westdal, Anne Kirk.
		\item Started 2019.
...
\end{block}	
\begin{block}{Impact on production and producers}
\begin{center}   
\begin{itemize} 
\item From data to information;   
\item The impact on consumers
 \end{itemize}
 \end{center}
 \end{block}
\end{frame}
...
\begin{frame}{Yield vs. Precipitation in Alberta}
\begin{center}
 \includegraphics[scale=0.35]{./figures/precip.png}
 \end{center}
\end{frame}
