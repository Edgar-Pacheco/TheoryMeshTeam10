...
\begin{itemize}
 \pause\item Information is power!
 \pause\item Currently, the relavent information resides in technical journals that is penetrable only for researchers and experts in the field. 
 \pause\item Needs to be available/intelligible to producers.
 \pause\item The general sentiment conveyed by industry participants:
 \begin{itemize}
 \pause\item There needs to be a change in the way that information is disseminated.
 \pause\item It used to be that the when/where/how questions of crop production were passed by word of mouth: ``Do this because it has always worked.''
 \pause\item This is no longer tenable with the rapidly changing climate/environmental conditions.
 \pause\item Over the coming decades that will span a contemporary producer's career, they will invariably need to adjust their approaches.
 \end{itemize}
\end{itemize}
...
\includegraphics[scale=0.25]{./figures/yields.png}
 ...
 \begin{itemize}
  \pause\item $K = K(x_1, x_2, \dots, x_n)$, where no $x_i$ is a temporal variable.
 \end{itemize}
...
\begin{center}
 \pause
 \includegraphics[width=3cm, height=2.75cm]{./figures/harvestOld}\includegraphics[width=3cm, height=2.75cm]{./figures/harvestNew}\\ \pause
