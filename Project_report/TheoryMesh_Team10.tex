...
To further evince the increasing productivity of Canadian crop yields, consider the data shown in Figure \ref{ABbarleyyields}, which shows the change in barley yields in Alberta \ccite.



The final question is how can this information be passed on the farmers. 
...
\begin{figure}[h!]
\centering
\includegraphics[scale=0.35]{ABfrost}
...
\begin{figure}[h!]
\centering
 \includegraphics[scale=0.35]{ABtemp}
...
\begin{figure}[h!]
\centering
 \includegraphics[scale=0.35]{AByield}
