...
\begin{itemize}
 ...
 \item Currently, the relevant information resides in technical journals that is penetrable only for researchers and experts in the field. 
...
\begin{frame}
\begin{center}
\includegraphics[scale=0.35]{./figures/Indicator_Value}  \includegraphics[scale=0.35]{./figures/Time_Value}
\end{center}
\end{frame} 
